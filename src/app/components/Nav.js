        ...
        <div className="flex justify-center flex-col sm:flex-row pr-16">
            ...
            <nav aria-label="Header Navigation" className="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0 ">
                <ul className="flex flex-col gap-y-4 sm:flex-row">
                    ...
                    <li className=""><a className="text-white font-extrabold pl-11 pr-2 text-xl trasnition-all east-in-out duration-300 hover:text-yellow-400" href="anime">Shows</a></li>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fcd34d" className="w-7 h-6">
