        ...
        <div className="flex justify-center flex-col sm:flex-row pr-16">
            ...
            <nav aria-label="Header Navigation" className="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0 ">
                <ul className="flex flex-col gap-y-4 sm:flex-row">
                    <li className=""><a className="text-white font-extrabold pr-2 text-xl trasnition-all east-in-out duration-300 hover:text-orange-400" href="">Home </a></li>
                    ...
                    <li className=""><a className="text-white font-extrabold pl-11 pr-2 text-xl trasnition-all east-in-out duration-300 hover:text-blue-400" href="projects">Projects</a></li> <svg class="w-5 h-6 text-gray-800 dark:text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" height="20px" width="20px ">
                        <path fill="#60a5fa" d="M16.025 15H14.91c.058-.33.088-.665.09-1v-1h2a1 1 0 0 0 0-2h-2.09a5.97 5.97 0 0 0-.26-1h.375a2 2 0 0 0 2-2V6a1 1 0 0 0-2 0v2H13.46a6.239 6.239 0 0 0-.46-.46V6a3.963 3.963 0 0 0-.986-2.6l.693-.693A1 1 0 0 0 13 2V1a1 1 0 0 0-2 0v.586l-.661.661a3.753 3.753 0 0 0-2.678 0L7 1.586V1a1 1 0 0 0-2 0v1a1 1 0 0 0 .293.707l.693.693A3.963 3.963 0 0 0 5 6v1.54a6.239 6.239 0 0 0-.46.46H3V6a1 1 0 0 0-2 0v2a2 2 0 0 0 2 2h.35a5.97 5.97 0 0 0-.26 1H1a1 1 0 0 0 0 2h2v1a6 6 0 0 0 .09 1H2a2 2 0 0 0-2 2v2a1 1 0 1 0 2 0v-2h1.812A6.012 6.012 0 0 0 8 19.907V10a1 1 0 0 1 2 0v9.907A6.011 6.011 0 0 0 14.188 17h1.837v2a1 1 0 0 0 2 0v-2a2 2 0 0 0-2-2ZM11 6.35a5.922 5.922 0 0 0-.941-.251l-.111-.017a5.52 5.52 0 0 0-1.9 0l-.111.017A5.924 5.924 0 0 0 7 6.35V6a2 2 0 1 1 4 0v.35Z" />
                    </svg>

                    <li className=""><a className="text-white font-extrabold pl-11 pr-2 text-xl trasnition-all east-in-out duration-300 hover:text-red-400" href="skills">Skills</a></li>
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" x="0px" y="0px" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#fb7185" viewBox="0 0 20 20" width="20" height="20" className="w-6 h-6">
                        <path d="M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" />
                    </svg>

                    <li className=""><a className="text-white font-extrabold pl-11 pr-2 text-xl trasnition-all east-in-out duration-300 hover:text-yellow-400" href="anime">Anime</a></li>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fcd34d" class="w-7 h-6">
